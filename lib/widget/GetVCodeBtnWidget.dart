...
class GetVCodeBtnWidget extends StatefulWidget {
  /// 倒计时的秒数，默认60秒。
  final int countdown;
  ...
  @override
  _GetVCodeBtnWidgetState createState() => _GetVCodeBtnWidgetState();
}

class _GetVCodeBtnWidgetState extends State<GetVCodeBtnWidget> {
  /// 倒计时的计时器。
  Timer _timer;
